...
class FramelessWindow(QMainWindow):
    ...
    def toggle_maximize(self):
        if self.isMaximized():
            ...
            self.central_widget.setStyleSheet(
                "QWidget#CentralWidget { background-color: #2e3440; border-radius: 15px; }"
            )
            self.title_bar.setStyleSheet(
                "QWidget { background-color: #232831; border-top-left-radius: 15px; border-top-right-radius: 15px; } QPushButton { color: white; border: none; background-color: transparent; width: 45px; height: 40px; } QPushButton:hover { background-color: rgba(255, 255, 255, 0.1); } QPushButton#CloseBtn:hover { background-color: #bf616a; } QLabel { color: #d8dee9; font-family: 'Segoe UI'; font-size: 13px; font-weight: bold; padding-left: 15px; }"
            )
            self.status_bar.setStyleSheet(
                "QStatusBar { background-color: #232831; color: #a3be8c; font-family: 'Segoe UI'; font-size: 11px; border-bottom-left-radius: 15px; border-bottom-right-radius: 15px; }"
            )
        else:
            self.showMaximized()
            self.btn_maximize.setText("🗗")
            ...
            self.central_widget.setStyleSheet(
                "QWidget#CentralWidget { background-color: #2e3440; border-radius: 0px; }"
            )
            self.title_bar.setStyleSheet(
                "QWidget { background-color: #232831; border-top-left-radius: 0px; border-top-right-radius: 0px; } QPushButton { color: white; border: none; background-color: transparent; width: 45px; height: 40px; } QPushButton:hover { background-color: rgba(255, 255, 255, 0.1); } QPushButton#CloseBtn:hover { background-color: #bf616a; } QLabel { color: #d8dee9; font-family: 'Segoe UI'; font-size: 13px; font-weight: bold; padding-left: 15px; }"
            )
            self.status_bar.setStyleSheet(
                "QStatusBar { background-color: #232831; color: #a3be8c; font-family: 'Segoe UI'; font-size: 11px; border-bottom-left-radius: 0px; border-bottom-right-radius: 0px; }"
            )
